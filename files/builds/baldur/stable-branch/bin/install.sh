...
function SP_SETUP_XFCE4_KEYBOARD_SHORTCUTS_USER {
    ...
    chown $USERNAME:$USERNAME /home/$USERNAME/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-keyboard-shortcuts.xml
...
function SP_SETUP_XFCE4_POWER_MANAGER_USER {
    ...
    chown $USERNAME:$USERNAME /home/$USERNAME/.config/xfce4/
    chown $USERNAME:$USERNAME /home/$USERNAME/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-power-manager.xml
}
